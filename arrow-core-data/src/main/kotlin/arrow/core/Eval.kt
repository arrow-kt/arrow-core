...
sealed class Eval<out A> : EvalOf<A> {
  ...
  companion object {
    ...
    inline fun <A, B, C> mapN(
      ...
      mapN(a, b, Unit, Unit, Unit, Unit) { aa, bb, _, _, _, _ -> map(aa, bb) }
//      a.flatMap { aa -> b.map { bb -> map(aa, bb) } }
    ...
    inline fun <A, B, C, D> mapN(
      ...
      mapN(a, b, c, Unit, Unit, Unit) { aa, bb, cc, _, _, _ -> map(aa, bb, cc) }
//      a.flatMap { aa -> b.flatMap { bb -> c.map { cc -> map(aa, bb, cc) } } }
    ...
    inline fun <A, B, C, D, E> mapN(
      ...
      mapN(a, b, c, d, Unit, Unit) { aa, bb, cc, dd, _, _ -> map(aa, bb, cc, dd) }
//      a.flatMap { aa ->
//        b.flatMap { bb ->
//          c.flatMap { cc ->
//            d.map { dd ->
...
//
    inline fun <A, B, C, D, E, F> mapN(
      ...
      mapN(a, b, c, d, e, Unit) { aa, bb, cc, dd, ee, _ -> map(aa, bb, cc, dd, ee) }
//      a.flatMap { aa ->
//        b.flatMap { bb ->
//          c.flatMap { cc ->
//            d.flatMap { dd ->
