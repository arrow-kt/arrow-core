...
class ValidatedTest : UnitSpec() {
  ...
  init {
    ...
    testLaws(
      ...
      HashLaws.laws(Validated.hash(String.hash(), Int.hash()), Arb.validated(Arb.string(), Arb.int()), EQ),
      OrderLaws.laws(Validated.order(String.order(), Int.order()), Arb.validated(Arb.string(), Arb.int())),
