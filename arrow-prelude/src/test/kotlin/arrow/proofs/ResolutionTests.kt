...
import arrow.refinement.RefinementTests
import arrow.typeclasses.GivenTest
...
class ResolutionTests {
  ...
  private val dependencies: List<Config>
    get() {
      val arrowVersion = System.getProperty("ARROW_VERSION")
      val arrowCoreDataDependency = Dependency("arrow-core-data:$arrowVersion")
      return CompilerTest.metaDependencies + CompilerTest.addArguments("-Xallow-jvm-ir-dependencies") +
        CompilerTest.addDependencies(arrowCoreDataDependency)
    }
